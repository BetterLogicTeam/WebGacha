...
export default function Single_tarpize_card({ card_p, carddimg, a1,setsliderName,setModalShow,index }) {
  return (
    <div className="single_tarpize_card mt-5">
      <div className="single_card_bg" onClick={()=>(setModalShow(true),setsliderName(index))}>
