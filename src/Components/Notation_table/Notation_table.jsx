  ...
  return (
    ...
    <div className="container-fluid resposfsfo bbgg notation_listUpper ">
      <div className="row justify-content-center mx-0">
        ...
        <div className="col-7 tableBg notataion_border p-3 border_mob1 forNewBrdRds_2">
          <p className="T_p">会社名</p>
        </div>
      </div>
      <div className="row justify-content-center mx-0">
        <div className="col-5 tableBg col-md-3  notataion_border p-3 border_mob">
          <p className="fwwwwwwwww_ttttt">運営管理会社</p>
        </div>
      ...
      <div className="row justify-content-center mx-0">
        <div className="col-5 tableBg col-md-3  notataion_border p-3 border_mob">
          <p className="fwwwwwwwww_ttttt">運営管理責任者</p>
        </div>
        <div className="col-7 tableBg notataion_border p-3 border_mob1">
          <p className="T_p">ジョン・スミス、会社名</p>
        </div>
      </div>
      <div className="row justify-content-center mx-0">
        <div className="col-5 tableBg col-md-3  notataion_border p-3 border_mob">
          <p className="fwwwwwwwww_ttttt">住所</p>
        </div>
        <div className="col-7 tableBg notataion_border p-3 border_mob1">
          <p className="T_p">35624 コネチカット州シラキュース市ソーンリッジ・サー2118番地</p>
        </div>
      </div>
      <div className="row justify-content-center mx-0">
        <div className="col-5 tableBg col-md-3  notataion_border p-3 border_mob">
