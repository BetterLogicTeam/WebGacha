...
function Confirmataion() {
  ...
  return (
   ...
   <h1 className='d-flex justify-content-center py-2 py-md-5 csjjidh '>お問い合わせ 確認</h1>
    <div className="row justify-content-center">
        <div className="col-5 d-flex align-items-center tableBg col-md-3  notataion_border p-3 border_mob border_table">
          <p className="ghgh">お問い合わ <br className='d-block d-md-none' />せ種別</p>
        </div>
        <div className="col-7 d-flex align-items-center tableBg notataion_border p-3 border_table1">
          <p className="hjhj">入会について </p>
        </div>
      </div>
      <div className="row justify-content-center">
        <div className="col-5 d-flex align-items-center tableBg col-md-3  notataion_border p-3 border_mob ">
          <p className="ghgh">お名前（フリガナ）</p>
        </div>
        <div className="col-7 d-flex align-items-center tableBg notataion_border p-3 ">
      ...
      <div className="row justify-content-center">
        <div className="col-5 d-flex align-items-center tableBg col-md-3  notataion_border p-3 ">
