...
function Password_request() {
  ...
  <div class="card-body">
    ...
    メールにてパスワード再設定のURLをお知らせいたします。※@zenco.co.jp からメールが受信できるよう設定を行ってください。
...
<input type="text" className=' my-3 w-100 pasword_input _border' id="fname" name="fname" placeholder='elunub3@gmail.com' />


    
    <button className='w-100 red_button '> 送信 </button>
  </div>
</div>
        </div>
    </div>
